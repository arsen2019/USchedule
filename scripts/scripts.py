...
async def add_initial_data():
    async with AsyncSession() as session:
        ...
        rooms_data = [
            ...
            {"name": "106/208", "building_name": "12"},
            {"name": "304", "building_name": "12"},
        ]
        ...
        teacher_data = [
            ...
            {
                "last_name_en": "Qamalyan",
                "first_name_en": "A",
                "last_name_hy": "Քամալյան",
                "first_name_hy": "Ա",
                "last_name_ru": "Камалян",
                "first_name_ru": "А",
                "department": "Mathematics",
            },
            {
        ...
        groups = []
        for group_ in group_data:
            major = next(m for m in majors if m.name == group_["major"])
            groups.append(Group(name=group_["name"], major_uuid=major.uuid))

        await commit_changes(session, groups)

        lab_data = [
            {"name": "1", "major": "Applied Mathematics and Informatics"},
            {"name": "2", "major": "Applied Mathematics and Informatics"},
            {"name": "3", "major": "Applied Mathematics and Informatics"},
            {"name": "4", "major": "Applied Mathematics and Informatics"},
        ]

        labs = []
        for lab_ in lab_data:
            major = next(m for m in majors if m.name == lab_["major"])
            labs.append(Lab(name=lab_["name"], major_uuid=major.uuid))
        ...
        for course in course_data:
            ...
            if "group_name" in course:
                group = next(g for g in groups if g.name == course["group_name"])
                print("Group: ", group)
            if "lab_name" in course:
                lab = next(l for l in labs if l.name == course["lab_name"])
                print("Lab: ", lab)
            courses.append(
                Course(
                    ...
                    lab_uuid=lab.uuid if lab else None,
