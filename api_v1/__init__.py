...
from api_v1.tracker.views import router as tracker_router

router_for_course = APIRouter()
router_for_group = APIRouter()
router_for_status = APIRouter()
router_for_tracker = APIRouter()
...
router_for_tracker.include_router(router=tracker_router, prefix="/tracker")
